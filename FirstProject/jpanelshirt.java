...
public class jpanelshirt extends JPanel {
   ...
   public jpanelshirt(JFrameMain win) {
      ...
      textField_3.setFont(new Font("맑은 고딕", Font.BOLD, 20));
      ...
      textField_4.setFont(new Font("맑은 고딕", Font.BOLD, 20));
      ...
      textField_5.setFont(new Font("맑은 고딕", Font.BOLD, 20));
      ...
      textField_6.setFont(new Font("맑은 고딕", Font.BOLD, 20));
      ...
      textField_7.setFont(new Font("맑은 고딕", Font.BOLD, 20));
      ...
      textField_8.setFont(new Font("맑은 고딕", Font.BOLD, 20));
      ...
      textField_9.setFont(new Font("맑은 고딕", Font.BOLD, 20));
      ...
      b1.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent arg0) {
            number = 1;
            SelectShirt pay = new SelectShirt();
         }
      });
